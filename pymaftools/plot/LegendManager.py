...
class LegendManager:
    ...
    def plot_legends(
        ...
        start_y: float = 0.95,
        rect_width: float = 0.06,
        rect_height: float = 0.02,
        text_offset_x: float = 0.14,
    ...
    def plot_horizontal_legend(
        ...
        spacing: tuple[float, float] = (0.15, 0.1),
    ) -> LegendManager:
        """
        ...
        for legend_name, color_dict in self.legend_dict.items():
            ...
            for row in range(rows):
                ...
                for col in range(columns):
                    ...
                    # Plot color rectangle
                    rect = Rectangle(
                        (x_position, y_position - rect_size[1] / 2),
                        rect_size[0],
                        rect_size[1],
                        facecolor=color,
                        edgecolor="none",
    ...
    def update_legend_colors(
        self, legend_name: str, color_updates: dict[str, str]
    ) -> LegendManager:
        """
    ...
    def create_from_dict(
        legend_dict: dict[str, dict[str, str]], ax: Axes.Axes | None = None
    ) -> LegendManager:
        """
    ...
    def add_shape_legend(
        self, legend_name: str, shape_dict: dict[str, str]
    ) -> LegendManager:
        """
